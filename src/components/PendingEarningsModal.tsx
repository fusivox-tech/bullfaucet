  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-md bg-bull-dark rounded-[2.5rem] border border-white/10 overflow-hidden"
      >
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">
                {pendingEarnings.length} {pendingEarnings.length === 1 ? 'earning' : 'earnings'} on hold
              </p>
            </div>
          </div>
          <button 
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(80vh-180px)] scrollbar-hide">
          ...
          <div className="mb-6 p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
            <div className="flex gap-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-blue-400 mb-1">Why are earnings on hold?</h3>
